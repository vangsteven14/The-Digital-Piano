# List displaying the keys used for left and right hand
# and the corresponding piano notes, white notes, black notes, and black note labels.

left_hand = ['Z', 'S', 'X', 'D', 'C', 'V', 'G', 'B', 'H', 'N', 'J', 'M']
right_hand = ['Y', '7', 'U', '8', 'I', 'O', '0', 'P', '-', '[', '=', ']']
